 ...
 * Created by senthil
 */
public class GolaZipGifRequest {
    ...
    private List<Idiom> idioms = new LinkedList<Idiom>();


    public GolaZipGifRequest(String path, UploadRequestStatus uploadRequestStatus, Date requestedDate, String source) {
        this.path = path;
